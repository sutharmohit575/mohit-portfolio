...
PROJECTS: list[Project] = [
    ...
    Project(
        slug="cryptovault",
        name="🔐 CRYPTOVAULT",
        description="Self-hosted password manager with zero-knowledge encryption, browser extension, TOTP 2FA.",
        tags=["Rust", "AES-256", "WASM", "SQLite"],
        biome="🔥 NETHER BIOME",
        repo_url="https://github.com/sutharmohit575/cryptovault",
        status="Open Source",
    ),
    Project(
        slug="autoscribe",
...
VIRTUAL_FS: dict[str, dict] = {
    ...
    "~/projects": {"type": "dir", "children": ["neuralchat", "pixelmart", "cryptovault", "autoscribe"]},
    ...
    "~/projects/cryptovault": {"type": "file", "content": ["NAME:    CryptoVault", "STACK:   Rust, AES-256, WASM, SQLite", "STATUS:  ● Open Source", "REPO:    github.com/sutharmohit575/cryptovault"]},
